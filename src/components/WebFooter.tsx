    ...
    <footer className="mt-16 border-t border-slate-200 bg-white text-slate-600 text-xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          {/* Services & Guarantees */}
          <div>
            <h4 className="font-bold text-slate-900 uppercase tracking-wider text-xs mb-3">Garantía & Soporte</h4>
        ...
        <div className="pt-8 mt-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-600 text-[11px]">
          ...
          <div className="flex items-center gap-4">
            <span className="hover:text-slate-900 transition-colors cursor-pointer">Términos del Servicio</span>
            <span>•</span>
            <span className="hover:text-slate-900 transition-colors cursor-pointer">Política de Privacidad</span>
            <span>•</span>
            <span className="hover:text-slate-900 transition-colors cursor-pointer">Garantía Escrow</span>
          </div>
        </div>
